...
class AgentToolController extends Controller
{
    ...
    protected array $tools = [
        ...
        'services.search' => [
            'controller' => ServiceCatalogItemController::class,
            'method' => 'index',
            'tier' => 'read',
            'module' => '4.15 Service Management',
            'feature_ref' => '4.15.1',
            'schema_version' => self::TOOL_SCHEMA_VERSION,
            'rbac' => ['model' => ServiceCatalogItem::class, 'action' => 'viewAny'],
            'roles' => ['admin', 'manager', 'agent'],
            'input_schema' => [
                'type' => 'object',
                'properties' => [
            ...
            'output_schema' => ['type' => 'object', 'description' => 'Paginated service catalog collection.'],
        ],
        'services.get' => [
            'controller' => ServiceCatalogItemController::class,
            'method' => 'show',
            ...
            'feature_ref' => '4.15.1',
            'schema_version' => self::TOOL_SCHEMA_VERSION,
            'rbac' => ['model' => ServiceCatalogItem::class, 'action' => 'view'],
            'roles' => ['admin', 'manager', 'agent'],
            'input_schema' => [
                'type' => 'object',
                'required' => ['service_catalog_item_id'],
                'properties' => ['service_catalog_item_id' => ['type' => 'string']],
            ],
            'output_schema' => ['type' => 'object', 'description' => 'Service catalog item detail.'],
        ],
        'service_requests.search' => [
            ...
            'feature_ref' => '4.15.2',
            'schema_version' => self::TOOL_SCHEMA_VERSION,
            'rbac' => ['model' => ServiceRequest::class, 'action' => 'viewAny'],
            'roles' => ['admin', 'manager', 'agent'],
            'input_schema' => [
                'type' => 'object',
                'properties' => [
            ...
            'output_schema' => ['type' => 'object', 'description' => 'Paginated service request collection.'],
        ],
        'service_requests.create' => [
            ...
            'feature_ref' => '4.15.2',
            'schema_version' => self::TOOL_SCHEMA_VERSION,
            'rbac' => ['model' => ServiceRequest::class, 'action' => 'create'],
            'roles' => ['admin', 'manager', 'agent'],
            'input_schema' => [
                'type' => 'object',
                'required' => ['catalog_item_id', 'requester_id', 'contact_id', 'channel'],
                'properties' => [
                    'catalog_item_id' => ['type' => 'string'],
                    ...
                    'status' => ['type' => 'string', 'enum' => ['submitted', 'under_review', 'in_progress', 'pending_customer', 'completed', 'closed']],
                    'priority' => ['type' => 'string', 'enum' => ['low', 'medium', 'high', 'urgent']],
                    'assigned_to' => ['type' => 'string'],
                    'team_id' => ['type' => 'string'],
                    'form_response' => ['type' => 'array'],
            ...
            'output_schema' => ['type' => 'object', 'description' => 'Created service request record.'],
        ],
        'service_requests.get_status' => [
            'controller' => ServiceRequestController::class,
            'method' => 'show',
            'tier' => 'read',
            'module' => '4.15 Service Management',
            'feature_ref' => '4.15.2',
            'schema_version' => self::TOOL_SCHEMA_VERSION,
            'rbac' => ['model' => ServiceRequest::class, 'action' => 'view'],
            'roles' => ['admin', 'manager', 'agent'],
            'input_schema' => [
                'type' => 'object',
                'required' => ['service_request_id'],
                'properties' => ['service_request_id' => ['type' => 'string']],
            ],
            'output_schema' => ['type' => 'object', 'description' => 'Service request detail and current status.'],
        ],
        'service_requests.update_status' => [
            ...
            'feature_ref' => '4.15.2',
            'schema_version' => self::TOOL_SCHEMA_VERSION,
            'rbac' => ['model' => ServiceRequest::class, 'action' => 'update'],
            'roles' => ['admin', 'manager', 'agent'],
            'input_schema' => [
                'type' => 'object',
            ...
            'output_schema' => ['type' => 'object', 'description' => 'Updated service request status.'],
        ],
        'service_requests.add_document_request' => [
            'controller' => ServiceRequestController::class,
            ...
            'input_schema' => [
                'type' => 'object',
                'required' => ['service_request_id', 'title'],
                'properties' => [
                    'service_request_id' => ['type' => 'string'],
                    'title' => ['type' => 'string'],
                    'description' => ['type' => 'string'],
            ...
            'output_schema' => ['type' => 'object', 'description' => 'Created document request.'],
        ],
        'cases.search' => [
            'controller' => CaseRecordController::class,
            'method' => 'index',
            'tier' => 'read',
            'module' => '4.15 Service Management',
            'feature_ref' => '4.15.3',
            'schema_version' => self::TOOL_SCHEMA_VERSION,
            'rbac' => ['model' => CaseRecord::class, 'action' => 'viewAny'],
            'roles' => ['admin', 'manager', 'agent'],
            'input_schema' => [
                'type' => 'object',
                'properties' => [
                    ...
                    'account_id' => ['type' => 'string'],
                    'contact_id' => ['type' => 'string'],
                    'pending_signoff' => ['type' => 'boolean'],
                    'per_page' => ['type' => 'integer', 'minimum' => 1, 'maximum' => 100],
                ],
            ],
            'output_schema' => ['type' => 'object', 'description' => 'Paginated case collection.'],
        ],
        'cases.create' => [
            'controller' => CaseRecordController::class,
            'method' => 'store',
            ...
            'feature_ref' => '4.15.3',
            'schema_version' => self::TOOL_SCHEMA_VERSION,
            'rbac' => ['model' => CaseRecord::class, 'action' => 'create'],
            'roles' => ['admin', 'manager', 'agent'],
            'input_schema' => [
                'type' => 'object',
                'required' => ['title'],
                'properties' => [
                    ...
                    'title' => ['type' => 'string'],
                    'type' => ['type' => 'string', 'enum' => ['service_delivery', 'complaint', 'compliance', 'dispute', 'investigation', 'escalation', 'custom']],
                    'priority' => ['type' => 'string', 'enum' => ['low', 'medium', 'high', 'urgent']],
                    'status' => ['type' => 'string', 'enum' => ['new', 'triaged', 'in_progress', 'pending_customer', 'pending_internal', 'resolution_proposed', 'closed', 'reopened']],
                    'owner_id' => ['type' => 'string'],
                    'primary_contact_id' => ['type' => 'string'],
                    'primary_account_id' => ['type' => 'string'],
                    'sla_instance_id' => ['type' => 'string'],
                    'root_cause' => ['type' => 'string'],
                    'resolution_details' => ['type' => 'string'],
                    'closure_summary' => ['type' => 'string'],
                    'signoff_required' => ['type' => 'boolean'],
                    'signoff_due_at' => ['type' => 'string'],
                    'metadata' => ['type' => 'array'],
                ],
            ],
            'output_schema' => ['type' => 'object', 'description' => 'Created case record.'],
        ],
        'cases.get' => [
            'controller' => CaseRecordController::class,
            'method' => 'show',
            ...
            'feature_ref' => '4.15.3',
            'schema_version' => self::TOOL_SCHEMA_VERSION,
            'rbac' => ['model' => CaseRecord::class, 'action' => 'view'],
            'roles' => ['admin', 'manager', 'agent'],
            'input_schema' => [
                'type' => 'object',
                'required' => ['case_id'],
            ...
            'output_schema' => ['type' => 'object', 'description' => 'Case detail record.'],
        ],
        'cases.update_status' => [
            'controller' => CaseRecordController::class,
            'method' => 'updateStatus',
            ...
            'feature_ref' => '4.15.3',
            'schema_version' => self::TOOL_SCHEMA_VERSION,
            'rbac' => ['model' => CaseRecord::class, 'action' => 'update'],
            'roles' => ['admin', 'manager', 'agent'],
            'input_schema' => [
                'type' => 'object',
            ...
            'output_schema' => ['type' => 'object', 'description' => 'Updated case status.'],
        ],
        'cases.add_note' => [
            'controller' => CaseRecordController::class,
            'method' => 'addNote',
            ...
            'output_schema' => ['type' => 'object', 'description' => 'Created case note.'],
        ],
        'cases.request_signoff' => [
            'controller' => CaseRecordController::class,
            'method' => 'requestSignoff',
            'tier' => 'write-reversible',
            'module' => '4.15 Service Management',
            'feature_ref' => '4.15.3',
            'schema_version' => self::TOOL_SCHEMA_VERSION,
            'rbac' => ['model' => CaseRecord::class, 'action' => 'signoff'],
            'roles' => ['admin', 'manager', 'agent'],
            'input_schema' => [
                'type' => 'object',
                'required' => ['case_id'],
            ...
            'output_schema' => ['type' => 'object', 'description' => 'Created case signoff request.'],
        ],
        'activities.create' => [
    ...
    private function parameterInputKey(string $method, string $parameterName): string
    {
        return match ("{$method}:{$parameterName}") {
            ...
            'show:serviceCatalogItem' => 'service_catalog_item_id',
            'show:serviceRequest' => 'service_request_id',
            'show:caseRecord' => 'case_id',
    ...
    private function guessModelClass(string $controllerClass): ?string
    {
        $map = [
            ...
            ServiceCatalogItemController::class => \App\Models\ServiceCatalogItem::class,
            ServiceRequestController::class => \App\Models\ServiceRequest::class,
            CaseRecordController::class => \App\Models\CaseRecord::class,
    ...
    private function extractRecordUrl(array $content, string $tool): ?string
    {
        $routeMap = [
            ...
            'services.search' => '/service-catalog',
            'services.get' => '/service-catalog',
            'service_requests.search' => '/service-requests',
            'service_requests.get_status' => '/service-requests',
            'service_requests.create' => '/service-requests/create',
            'service_requests.update_status' => '/service-requests',
            'service_requests.add_document_request' => '/service-requests',
            'cases.search' => '/cases',
            'cases.get' => '/cases',
            'cases.create' => '/cases/create',
            'cases.update_status' => '/cases',
            'cases.add_note' => '/cases',
            'cases.request_signoff' => '/cases',
