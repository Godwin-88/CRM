...
class ServiceRequestClosed extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Service request closed')
            ->line('Service request '.$this->serviceRequest->id.' has been closed.')
